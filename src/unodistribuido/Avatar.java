...
public class Avatar extends javax.swing.JDialog {
    ...
    private String[] nombres={"Tony","Carlos","Emiliano","Juan","Emilio","Paulo"};
    ...
    private void initComponents() {
        ...
        lblNick.setBackground(new java.awt.Color(204, 204, 204));
        lblNick.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        lblNick.setForeground(new java.awt.Color(0, 204, 204));
